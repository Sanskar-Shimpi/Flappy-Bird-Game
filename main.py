#Project By Sanskar Manoj Shimpi
...
def main():
    ...
    pygame.display.set_caption('Flappy Bird Game ~ By Sanskar Shimpi')
    ...
    if hT >= 19:
    	IMAGES['message'] = pygame.image.load('assets/sprites/message-night.png').convert_alpha()
    else:
    	IMAGES['message'] = pygame.image.load('assets/sprites/message-day.png').convert_alpha()
